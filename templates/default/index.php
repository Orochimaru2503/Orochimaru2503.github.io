...
<body class=" <?php echo $data["custom_body_bg"] . ' ' . $data["custom_body_tx"]; ?>">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
			...
			<!-- left -->
            <div class="col-xs-6 col-md-3 col-md-pull-6"><iframe src="https://coinmedia.co/new_code_site66506.js" scrolling="no" frameborder="0" width="300px" height="630px"></iframe></div>
            <!-- right -->
			<div class="col-xs-6 col-md-3"><iframe src="https://coinmedia.co/new_code_site66508.js" scrolling="no" frameborder="0" width="300px" height="630px"></iframe></div>
        </div>
        <div class="row">
